...
import com.example.Document_microservice.document.exeption.TheStoryDoesNotBelongToThisUser;
import com.example.Document_microservice.document.exeption.TheUserHasSeveralRoles;
import com.example.Document_microservice.document.exeption.UserDoesNotHaveARole;
...
public class CheckerDataAccountImpl implements CheckerDataAccount {
    ...
    @Override
    public boolean verificationUser(Long pacientIdOfHistory, Long userId) {
