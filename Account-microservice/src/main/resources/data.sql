...
(1, 'admin', 'admin', 'admin', crypt('admin', gen_salt('bf')), FALSE),
(2, 'manager', 'manager', 'manager', crypt('manager', gen_salt('bf')), FALSE),
(3, 'doctor', 'doctor', 'doctor', crypt('doctor', gen_salt('bf')), FALSE),
(4, 'user', 'user', 'user', crypt('user', gen_salt('bf')), FALSE)
